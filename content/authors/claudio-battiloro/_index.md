...
organizations:
  - name: Harvard University
    url: 'https://hsph.harvard.edu/profile/claudio-battiloro/'

bio: My research interests include theory and methods for topological signal processing and deep learning, AI for healthy climate adaptation, and distributed stochastic optimization. 
...
interests:
  ...
  - AI for Healthy Climate Adaptation
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:cbattiloro@hsph.harvard.edu'
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/claudio-battiloro-b4390b175/
  - icon: github
    icon_pack: fab
